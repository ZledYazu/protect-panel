...
# PROTECT PANEL V1.0.0 - HOTFIX EDITION
# Author: @ZledYazu
...
class ProtectPanel:
    ...
    def menu(self):
        ...
        print(f"{Fore.YELLOW} 2{Fore.WHITE}. Install Panel Protections (9 files)")
        ...
        print(f"{Fore.YELLOW} 7{Fore.WHITE}. Install ALL Protections (2+3+4+5+6)")
        print(f"{Fore.YELLOW} 8{Fore.WHITE}. Check Status")
        print(f"{Fore.YELLOW} 9{Fore.WHITE}. Exit{Style.RESET_ALL}")
...
if __name__ == "__main__":
    try:
        ...
        print(f"{Fore.RED}Error: {e}{Style.RESET_ALL}")        if ($user->id !== 1) {
            abort(403, '⛔ No Access - You Are Not ID 1 ©Protect By @ZledYazu');
        }
        return view('admin.servers.index');
    }
